...
public class Block extends Node {
    ...
    public final static NodeUtil.Children children = new NodeUtil.Children<StmtList>()
            .or(LexicalType.DO, LexicalType.WHILE, Cond.class, LexicalType.NL, StmtList.class, LexicalType.LOOP, LexicalType.NL)
            .or(LexicalType.DO, LexicalType.UNTIL, Cond.class, LexicalType.NL, StmtList.class, LexicalType.LOOP, LexicalType.NL);
}
